"""
round_robin_algorithm.py  –  Round Robin (Preemptive)
...
def _run_rr(process_count, arrival_time, burst_time, time_quantum):
    ...
    current_time=0; queue=[]; completed=0; cpu_idle_time=0; entered=[False]*process_count
    gantt_chart=[]
...
def round_robin_gui():
    ...
    def _run():
        ...
        r=_run_rr(len(entry_rows),arrival,burst,tq); _render(out,r)
